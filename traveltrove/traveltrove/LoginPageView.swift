...
class LoginPageView: UIView {
    ...
    func setupLoginButton() {
        ...
        //loginButton.widthConstraint.constant = 50
        //loginButton.heightConstraint.constant = 50
...
func initConstraints(){
    NSLayoutConstraint.activate([
        ...
        //ogoLabel.leadingAnchor.constraint(equalTo:
      ...
      //                                      100),
        ...
        welcomeLabel.leadingAnchor.constraint(equalTo:
                                                    self.safeAreaLayoutGuide.leadingAnchor, constant:
        40),
        welcomeLabel.trailingAnchor.constraint(equalTo:
        ...
        messageLabel.leadingAnchor.constraint(equalTo:
                                                    self.safeAreaLayoutGuide.leadingAnchor, constant:
        40),
        messageLabel.trailingAnchor.constraint(equalTo:
                                                        self.safeAreaLayoutGuide.trailingAnchor,
        constant: -16),
        ...
        passwordField.leadingAnchor.constraint(equalTo:
                                                        self.safeAreaLayoutGuide.leadingAnchor, constant:
        40),
        passwordField.trailingAnchor.constraint(equalTo:
                                                        self.safeAreaLayoutGuide.trailingAnchor,
        constant: -40),
        ...
        loginButton.leadingAnchor.constraint(equalTo:
                                                        self.safeAreaLayoutGuide.centerXAnchor, constant:
        64),
