...
class NewDocView: UIView {
	...
	func initConstraints(){
        NSLayoutConstraint.activate([
            ...
            notesField.leadingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leadingAnchor, constant: 16),
            notesField.trailingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.trailingAnchor, constant: -16),
